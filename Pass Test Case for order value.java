...
// Fail test case before the order velue feature develop
    ...
    // Test case After the order value feature developed
    @Test
    public void get_order_value_should_return_correct_order_value_for_selected_items() throws itemNotFoundException {
        List<String> selectedItems = new ArrayList<>();
        selectedItems.add("Sweet corn soup");
